...
const operationsDoc = `query GetLatestTracks @netlify(id: """c76ade7d-f76d-4b8d-9a02-1ae08c617400""", doc: """Get the last track listened to on Spotify.""") {
  me {
    spotify {
...
exports.fetchGetLatestTracks = (
      variables,
      options
    ) => {
      return fetchNetlifyGraph({
        query: operationsDoc,
        operationName: "GetLatestTracks",
        variables: variables,
        options: options || {},
      });
    }
...
const functions = {
  /**
  * Get the last track listened to on Spotify.
  */
  fetchGetLatestTracks: exports.fetchGetLatestTracks
}
