...
![Google search page showing link to Google foo.bar](/img/foo-bar/page-reveal.jpg?nf_resize=fit&h=800 'Google search page showing link to Google foo.bar')
...
![Submission successful. Completed in 1 hour, 58 mins, 1 second](/img/foo-bar/challenge1-complete.jpeg?nf_resize=fit&h=800 'Submission successful. Completed in 1 hour, 58 mins, 1 second')
...
![Table showing 100% for level 1](/img/foo-bar/status-end-of-challenge1.jpeg?nf_resize=fit&h=800 'Table showing 100% for level 1')
